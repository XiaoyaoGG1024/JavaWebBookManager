                    ...
                    <ul class="nav navbar-nav navbar-right">
                        <li class="dropdown">
                            <a href="#" role="button" class="dropdown-toggle" data-hover="dropdown"> <i
                                    class="glyphicon glyphicon-user"></i> 欢迎您${sessionScope.aid}
                                <i class="caret"></i></a>
                    ...
                    <table id="data_list" class="table table-hover table-bordered" cellspacing="0" width="100%">
                        ...
                        <td>
                            ...
                            <%--,<%= bean.getPhone() %>,<%= bean.getPassword() %>,<%= bean.getLend_num() %>,<%= bean.getMax_num() %>)">修改</button>--%>
                                    onclick="showInfo2(<%= bean.getAid() %>)">修改
                            </button>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-7">
                                <%--@declare id="updateisbn"--%><input type="hidden" id="updateaid" name="aid">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-7">
                                <%--@declare id="updatebookname"--%><input type="text" class="form-control"
                                                                           id="updatename" name="name" placeholder="">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-7">
                                <%--@declare id="updateautho"--%><input type="text" class="form-control"
                                                                        id="updateemail" name="email" placeholder="">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-7">
                                <%--@declare id="updatepress"--%><input type="text" class="form-control"
                                                                        id="updatephone" name="phone" placeholder="">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            <label for="firstname" class="col-sm-3 control-label">可借阅天数</label>
                            <div class="col-sm-7">
                                <%--@declare id="addnum"--%><input type="text" class="form-control" name="lend_num"
                                                                   id="updatelend_num" required="required"
