        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="collapse navbar-collapse main-navbar-collapse">
                    <a class="navbar-brand" href="#"><strong>读者端图书馆管理系统</strong></a>
                    <ul class="nav navbar-nav navbar-right">
                        <li class="dropdown">
                            <a href="#" role="button" class="dropdown-toggle" data-hover="dropdown"> <i class="glyphicon glyphicon-user"></i>欢迎您${sessionScope.aid}<i class="caret"></i></a>
                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="bootstrap-admin-panel-content">
                            <ul>
								...
								<br>
								<li>联系我们:</li><br>
								<li><a href="https://blog.csdn.net/qq_54737884?spm=1000.2115.3001.5343">CSDN</a></li><br>
								<li><a href="https://gitee.com/its-brother-xiaoyao">Gitee</a></li><br>
                            </ul>
                        </div>
                    </div>
                </div>
